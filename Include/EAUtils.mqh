...
public:
    ...
    bool BuyNow(double sl, double tp)
    {
        return order(ORDER_TYPE_BUY, magicNumber, Ask(), sl, tp, risk, martingale, martingaleRisk, slippage, false, false, "", NULL, 0, nRetry, mRetry, 0, 0, 0, newsMinsAfter, filling, riskMode);
    }
